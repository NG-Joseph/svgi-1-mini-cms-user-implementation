...
const EditUser: React.FC<Props> = (props) => {
    ...
    const initialUserState: IUser = {
        ...
        resetPasswordExpiration: props.user.resetPasswordExpiration,
                    ...
                    <form onSubmit={onSubmit}>
                        ...
                        <div className="field">
                            ...
                            <div className="control">
                                <input className="input" type="text" placeholder="Code input" name="code" value={user.firstName} onChange={onChange} required/>
                            </div>
                        </div>
                        <div className="field">
                        ...
                        <div className="field">
                            ...
                            <div className="control">
                                <input className="input" type="text" placeholder="Email Address" name="contactFirstName" value={user.contactFirstName} onChange={onChange} required/>
                            </div>
                        ...
                        <div className="field">
                            ...
                            <div className="control">
                            <input className="input" type="date" placeholder="Date of birth" name="dateOfBirth" value={(typeof(user.dateOfBirth)== "string" ) ? Date.parse(user.dateOfBirth) : undefined} onChange={onChange}/>
                            </div>
                        </div>
